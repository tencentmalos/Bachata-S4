...
r=pathlib.Path.cwd();o=r/'build/thread-attrs-review/apk-thirteenth';o.mkdir(exist_ok=False);adb=['/Users/bytedance/Library/Android/sdk/platform-tools/adb','-s','9c2841a4']
