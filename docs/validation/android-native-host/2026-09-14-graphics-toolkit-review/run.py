...
bool EndFrameCapture() override { return false; }
...
commands = registry + capture + ["src/core/diagnostics/diagnostics_commands.cpp",
...
results.append(run("counterexamples", commands))
