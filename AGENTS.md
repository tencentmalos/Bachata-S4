...
- Read [the 2026-09-08 follow-up fix](docs/validation/v0/followup-2026-09-08.md) and [the original V0 review](docs/validation/v0/review-2026-09-08.md) before continuing implementation. After fixing shared FEX translation-cache invalidation in the main adapter, the Swan guest execution harness passes 36/36 assertions, including repeated same-VA publication across thread lifetimes. This is still `V0_IN_PROGRESS`: full quiescence, HLE buffer lifetimes, runner acceptance mapping and app integration remain incomplete. Harness assertion counts are not full V0 acceptance counts.
