...
public:
    // Constructor
    static constexpr uint8_t Exponent1[] = {
    ...
    // exponent2 = d mod (q - 1)
    static constexpr uint8_t Exponent2[] = {
    ...
    // e
    static constexpr uint8_t PublicExponent[] = {0, 1, 0, 1};
    // (InverseQ)(q) = 1 mod p
    static constexpr uint8_t Coefficient[] = {
    ...
    // n = p * q
    static constexpr uint8_t Modulus[] = {
        ...
        0x27};
    // p
    static constexpr uint8_t Prime1[] = {
    ...
    // q
    static constexpr uint8_t Prime2[] = {
    ...
    static constexpr uint8_t PrivateExponent[] = {
...
public:
    ...
    // e
    static constexpr uint8_t PublicExponent[] = {0x00, 0x01, 0x00, 0x01};
    // (InverseQ)(q) = 1 mod p
    static constexpr uint8_t Coefficient[] = {
