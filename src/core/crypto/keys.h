...
public:
    ...
    // e
    static constexpr u8 PublicExponent[] = {0, 1, 0, 1};
    // (InverseQ)(q) = 1 mod p
    static constexpr u8 Coefficient[] = {
    ...
    static constexpr u8 PrivateExponent[] = {
